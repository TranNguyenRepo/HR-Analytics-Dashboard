...
- Highlights top employee exit drivers
- Compares voluntary vs involuntary turnover
- Tracks termination trends
- Branch-level insights for HR action
...
- Analyzes exit feedback for retention strategy
- Identifies high-exit roles
- Groups departure themes
- Uses sentiment scoring (-1 to +1)
- Word cloud reveals recurring improvement areas
